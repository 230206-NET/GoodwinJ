...
//Reading user input via Console.ReaLine method, which returns string
string userInput = Console.ReadLine()!;

//Exception Handling:
//Exception stands for "Exceptional Events" and they represent an extra-ordinary that is outside of normal operation of a particular methods
...
// The runtime automatically releases memories of variables that are out of space
...
for(int i = 1; i <= parsedInput; i++) {
    ...
    // a number is a multiple of 3 if the number divided by 3 has a remainder of 0
    // If/ElseIf/Else blocks also flows top to bottom
